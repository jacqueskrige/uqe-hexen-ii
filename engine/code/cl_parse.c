...
#include "quakedef.h"
//#include "r_shared.h" // jkrige - removed
#include <windows.h>

extern	cvar_t	sv_flypitch;
extern	cvar_t	sv_walkpitch;
extern 	cvar_t	bgmmidi; // jkrige - fmod sound system
...
char *svc_strings[] =
{
	...
	"svc_fmod",				// jkrige - fmod sound system
...
//			Con_Printf ("svc_nop\n");
		...
		// jkrige - fmod sound system - begin
		//        - this will be used (after gathering info from svc_cdtrack and svc_midi_name) as the opportunity to start playback
		case svc_fmod:
			MSG_ReadString(); // this isn't used anymore, but has to be processed to keep compatibility with recorded demos
			byte cdtrack;
