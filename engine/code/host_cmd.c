...
// load the edicts out of the savegame file
	while (!feof(f))
	{
		...
		else
		{
			...
			// jkrige - sezero  2011-06-19 (https://sourceforge.net/p/uhexen2/code/4062/)
			...
			if (!ent->free)
			{
				// jkrige - sezero  2011-06-18 (https://sourceforge.net/p/uhexen2/code/4053/)
				if (entnum >= sv.num_edicts)
				{
					 ...
					 * the map.)  -- O.S. */
					Con_DPrintf("LoadGamestate(): entnum %d >= sv.num_edicts (%d)\n", entnum, sv.num_edicts);
					...
					else
					{
						...
						Con_DPrintf("LoadGamestate(): entity %d NOT restored!\n", entnum);
					}
				}
				// jkrige - sezero  2011-06-18 (https://sourceforge.net/p/uhexen2/code/4053/)
