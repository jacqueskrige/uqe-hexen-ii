...
//	MSG_WriteByte (&client->message, sv.edicts->v.soundtype);
	...
	MSG_WriteByte (&client->message, svc_fmod);
	MSG_WriteString (&client->message, NULL); // this isn't used anymore, but has to be processed to keep compatibility with recorded demos
